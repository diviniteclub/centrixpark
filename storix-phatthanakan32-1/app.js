...
const defaultUnits = unitIds.map((id) => {
  ...
  return {
    ...
    area: "106 ตร.ม.",
    price,
    status: ["LN1", "LN3", "LN5", "LN6", "LN7", "LN8", "LN9", "LN12", "LN14", "LN16", "LN18", "LN19", "LN23", "LN24"].includes(id) ? "reserved" : "available",
...
const storageKey = "storix-phatthanakan32-1-units-v16";
